...
trait RtmpAudioHandlerTrait
{
    ...
    public function rtmpAudioHandler()
    {
        ...
        //todo on_frame 事件 定义在MediaServer::addPublish()方法里面  这他么跳转的也太远了，鬼知道写的啥
        // TODO MediaServer::addPublish($this); 在RTMPinvokeHandlerTrait.PHP 处理命令的时候调用了媒体服务中心，关联上这个on_frame事件的
        /** 绑定On_fram事件 ，传入数据包 */
